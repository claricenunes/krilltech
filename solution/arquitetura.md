# Arquitetura técnica — Krill Radar

Documento de referência técnica do projeto. Hackathon PMI-DF 2026 — Desafio Krill Tech.

## 1. Visão geral

O Krill Radar é dividido em duas camadas que se conectam por um contrato OpenAPI:
...
## 9. Status deste documento

Versão **aprovada** da arquitetura técnica, mantida em `solution/arquitetura.md` (pasta de entregáveis do hackathon). Uma cópia de referência/trabalho equivalente vive em `docs/arquitetura.md`.
